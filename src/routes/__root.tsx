...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kit Torcedor Brasil Oficial — Copa 2026" },
      { property: "og:description", content: "12 itens incríveis para sua torcida. Frete grátis + pagamento na entrega!" },
